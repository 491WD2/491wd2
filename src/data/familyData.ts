...
export const initialFamilyData: FamilyData = {
  ...
  messageBoard: [
    {
      ...
      message: "Can someone pick up Stella at 5pm today?",
      category: "Reminder",
      colorKey: "blue",
      priority: "important",
      pinned: true,
      authorMemberId: "member-1",
      createdAt: "2026-08-10T21:41:00.000Z",
      updatedAt: "2026-08-10T21:41:00.000Z",
    },
    {
      id: "msg-seed-2",
      title: "Groceries",
      message: "I'll grab the groceries on the way home.",
      category: "Shopping",
      colorKey: "teal",
      priority: "normal",
      pinned: false,
    ...
    },
    {
      id: "msg-seed-3",
      title: "Pet meds",
      message: "Heartworm reminder is on the Pets page.",
      category: "Medical",
      colorKey: "rose",
      priority: "normal",
      pinned: false,
  ...
  notifications: [
    {
      ...
      type: "inventory_low",
      title: "Pantry needs attention",
      body: "Check low and out-of-stock items before the next shop.",
    ...
    },
    {
      ...
      body: "A few cleaning tasks are still open on Home.",
  ...
  storageLocations: [
    ...
    {
      id: "place-laundry-freezer",
      name: "Laundry Room Freezer",
